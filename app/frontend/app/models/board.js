...
//          console.log('missing sound ' + button.sound_id);
  ...
  contextualized_buttons: function(label_locale, vocalization_locale, history, capitalize, inflection_shift) {
    ...
    res.forEach(function(b) { delete b['dim']; });
