        ...
        if(next_step) {
          ...
          if(short_circuit || !levels[working.level][working.step]) {
            ...
            if(level.more_libraries) {
              if(true) { // don't hang out in symbol-testing level for more than 5 minutes total
                working.level--;
                working.step++;
