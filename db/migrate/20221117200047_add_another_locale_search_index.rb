class AddAnotherLocaleSearchIndex < ActiveRecord::Migration[5.0]
  disable_ddl_transaction!
  def change
    enable_extension "btree_gin"
    remove_index :board_locales, name: :board_locales_search_string2
    ...
    execute "CREATE INDEX CONCURRENTLY board_locales_search_string3 ON board_locales USING GIN((to_tsvector('simple'::regconfig, COALESCE((search_string)::text, ''::text)) @@ '''core'''::tsquery))"
