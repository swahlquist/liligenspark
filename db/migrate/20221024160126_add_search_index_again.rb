class AddSearchIndexAgain < ActiveRecord::Migration[5.0]
  disable_ddl_transaction!
  def change
    enable_extension "btree_gin"
    execute "CREATE INDEX CONCURRENTLY boards_search_string2 ON boards USING GIN(COALESCE(search_string,''::TEXT))"
  end
end
